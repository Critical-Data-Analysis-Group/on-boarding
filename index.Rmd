---
title: "Critical Data Analysis Group Collaboration Protocols"
author: "Prof. Lindsay Poirier"
...
Welcome to the Critical Data Analysis Group Collaboration Protocols! Here we outline the values that guide our work, group roles and responsibilities, protocols for facilitating meetings, guidelines for documenting our work, and expectations on group conduct. 
...
## As collaborators, we will:
1. *Respect* each other’s boundaries, inside and outside of the lab. Understand and be receptive to when others set boundaries. 
2. *Be open* to questions. Respect people’s prior knowledge, and be open to new ideas. 
3. *Support* one another by celebrating each other’s successes and acknowledging their work. 
4. *Support* one another, especially when there are hiccups. Offer to help, a fresh set of eyes will always be useful.
5. *Communicate* with care and transparency. We know that everyone has other commitments that might interfere with their work.
6. *Provide* clear instruction on project timeline, expectations, progress, and issues. 
7. *Update* the team of progress and if issues arise.
8. *Be proactive!* Problems will be common, take initiative to rectify the situation. 
9. *Distribute* even amounts of responsibility and do not wait for the last minute to accomplish the work needed. 
10. *Listen!* Communication is key in collaborations, so be willing to compromise and listen to each other’s opinions and ideas, as well as when others are uncomfortable.

## It is important to:
1. *Provide* constructive and sensitive criticism, as well as be willing to have assumptions be challenged. We can always learn from others.
2. *Be open* to discussion. We are on the same team, but disagreement is always alright. However, when disagreeing we criticize the ideas, not the topics. 
3. *Honor* each other’s identities and backgrounds. We all come from different levels of knowledge. 
4. *Be optimistic!* Being supportive throughout the project provides a thriving environment. 
5. *Ensure equity* in different outcomes. Do not exploit community groups we collaborate with. 
6. *Recognize* the unintended impact our work may have on people and communities, as well as understanding our knowledge’s limit on the social situations of others.  
7. *Promote* gratitude by ensuring citational equity. 
8. *Understand* that the topics we discuss are serious and real problems. Approach the topics, questions, and other perspectives with curiosity rather than judgment. 
9. *Transparency* on limitations of our research. Having a nuanced discussion on what we see, but what we cannot or do not know.
...
As the director of the Critical Data Analysis Group, I commit to:
...
When you join the lab, you will be added to our [GitHub organization](https://github.com/Critical-Data-Analysis-Group). We will keep most lab protocols, documents, and code in repositories under this organization. There are series of repository templates available for creating new GitHub repositories. We've created these templates to ensure consistency across our folder structures and completeness in the contents of our README documents. Please be sure to select the appropriate template before creating a new repo. Reach out to Lindsay if you are unsure of which template is most appropriate.
...
The Critical Data Analysis Group is dedicated to providing a harassment-free experience for everyone, regardless of gender, gender identity and expression, sexual orientation, disability, physical appearance, body size, age, race, or religion. We do not tolerate harassment of participants in any form.

This code of conduct applies to all Critical Data Analysis Group spaces, including lab meetings, our Slack Workspace, and our GitHub, both online and off. Anyone who violates this code of conduct may be sanctioned or expelled from these spaces at the discretion of the project director.

Some Critical Data Analysis Group spaces may have additional rules in place, which will be made clearly available to participants. Participants are responsible for knowing and abiding by these rules.
